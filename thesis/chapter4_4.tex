...
\begin{figure}[htbp]
  ...
  \node[manual, below=of L1] (L2)
        {Click thủ công\\{\scriptsize khởi tạo vpDot2}};
  \node[dotbox, below=of L2] (L3)
        {JOINT\\{\scriptsize vpDot2 tracking}};
  \node[manual, below=of L3] (L4)
  ...
  \draw[thick, dashed, gray!50]
      ($(L1.east)!0.5!(R1.west)+(0,0.8)$) -- ++(0,-7.0);
