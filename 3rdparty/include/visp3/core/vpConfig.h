...
// ViSP minor version.
#define VISP_VERSION_MINOR 7

// ViSP patch version.
#define VISP_VERSION_PATCH 1

// ViSP version with dots "3.7.1".
#define VISP_VERSION 3.7.1
...
#define ENABLE_IMAGE_TOOLS_WARP
...
// Defined if using a headless version of OpenCV
/* #undef VISP_HAVE_OPENCV_HEADLESS */

// OpenCV version in hexadecimal (for example 2.1.0 gives 0x020100).
#ifdef VISP_HAVE_OPENCV
#  define VISP_HAVE_OPENCV_VERSION (4<<16 | 5<<8 | 4)
...
#define VISP_RUBIK_REGULAR_FONT_RESOURCES "/home/nguyen/visp-ws/visp/3rdparty/data/font/Rubik-Regular.ttf;/usr/share/visp-3.7.1/data/font/Rubik-Regular.ttf"

// Defined the path to the basic scenes used by the simulator
#define VISP_SCENES_DIR "/home/nguyen/visp-ws/visp/3rdparty/data/wireframe-simulator;/usr/share/visp-3.7.1/data/wireframe-simulator"

// Defined the path to the robot's arms 3D model used by the robot simulators
#define VISP_ROBOT_ARMS_DIR "/home/nguyen/visp-ws/visp/3rdparty/data/robot-simulator;/usr/share/visp-3.7.1/data/robot-simulator"

// Defined if Ogre3d is available.
/* #undef VISP_HAVE_OGRE */
#ifdef VISP_HAVE_OGRE
#  define VISP_HAVE_OGRE_VERSION 
#endif
...
#  define VISP_HAVE_FRANKA_VERSION 
#endif
...
#define VISP_HAVE_PCL_VERSION 
/* #undef VISP_HAVE_PCL_COMMON */
/* #undef VISP_HAVE_PCL_FILTERS */
/* #undef VISP_HAVE_PCL_IO */
/* #undef VISP_HAVE_PCL_SEGMENTATION */
/* #undef VISP_HAVE_PCL_VISUALIZATION */
#endif
...
/* #undef VISP_HAVE_NLOHMANN_JSON_FROM_VTK */
...
#define VISP_HAVE_DATASET
#ifdef VISP_HAVE_DATASET
#  define VISP_HAVE_DATASET_VERSION (3<<16 | 5<<8 | 0)
#endif
