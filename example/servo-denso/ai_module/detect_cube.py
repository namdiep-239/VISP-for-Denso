#!/usr/bin/env python3
"""
Single-image cube detection for ViSP-for-Denso integration.
Called as a subprocess by the C++ application.

Usage:
    python3 detect_cube.py <image_path>
...
def main():
    ...
    edgetpu_path_str = cfg.get("model_path", "ai_module/models/cube_detector_int8_edgetpu.tflite")
    # CPU model path (standard int8 TFLite, no EdgeTPU custom op)
    cpu_path_str = cfg.get("cpu_model_path", "ai_module/models/cube_detector_int8.tflite")
