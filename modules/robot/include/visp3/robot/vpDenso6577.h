...
#ifndef vpDenso6577_h
#define vpDenso6577_h
...
*/
class VISP_EXPORT vpDenso6577 : public vpDenso
{
public:
  ...
  */
  ...
  /** @name Inherited functionalities from vpDenso6577 */
  //@{
  void init(void);
...
protected:
  /** @name Protected Member Functions Inherited from vpDenso650 */
  //@{
  //! Set the current tool type
  void setToolType(vpDenso6577::vpToolType tool) { tool_current = tool; }
  //@}
